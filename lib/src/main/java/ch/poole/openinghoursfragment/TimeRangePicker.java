...
public class TimeRangePicker extends DialogFragment
{
	...
	static void showDialog(FragmentActivity activity, 
	    ...
	    TimeRangePicker timePickerFragment = newInstance(title, startHour, startMinute,
	    		false,
	    		endHour, endMinute, listener);
	...
	static public void showDialog(FragmentActivity activity, 
	    ...
	    TimeRangePicker timePickerFragment = newInstance(title, startHour, startMinute,  
	    		true,
	    		NOTHING_SELECTED, NOTHING_SELECTED, listener);
	    timePickerFragment.show(fm, TAG);
	}
	 ...
	 */
    static private TimeRangePicker newInstance(int title, int startHour, int startMinute, 
    		boolean startOnly,
